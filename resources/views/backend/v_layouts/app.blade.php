...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('image/Logo MID.jpg') }}">
    <title>MARSSTORE.ID</title>
    <!-- Custom CSS -->
    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{ asset('image/Logo MID.jpg') }}" alt="homepage" class="light-logo" />
                        ...
                        <span class="logo-text">
                             <!-- dark Logo text -->
                             <img src="{{ asset('image/MARSSTORE.ID.jpg') }}" alt="homepage" class="light-logo" />
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer text-center">
                Web Programming. MARSSTORE.ID <a href="https://bsi.ac.id/">Kuliah..? BSI Aja !!!</a>
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
